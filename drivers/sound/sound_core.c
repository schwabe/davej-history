 ...
 *	list. Acquires locks as needed (none in 2.0)
 */
...
#include <linux/symtab_begin.h>
	X(register_sound_special),
	X(register_sound_mixer),
	X(register_sound_midi),
	X(register_sound_dsp),
	X(unregister_sound_special),
	X(unregister_sound_mixer),
	X(unregister_sound_midi),
	X(unregister_sound_dsp),
